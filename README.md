...
<h2>Output:</h2>
<div>
<img src="/assets/images/project003-output.PNG" width="500" >
</div>
...
<h2>Output:</h2>
<div>
<img src="/assets/images/project004-output.PNG" width="500" >
</div>
...
<h2>Output:</h2>
<div>
<img src="/assets/images/project005-output.PNG" width="500" >
</div>
...
<h2>Output:</h2>
<div>
<img src="/assets/images/project006-output.PNG" width="500" >
</div>
<hr/>
...
<h2>Output:</h2>
<div>
<img src="/assets/images/project007-output.PNG" width="500" >
</div>
<hr/>
...
<h2>Output:</h2>
<div>
<img src="/assets/images/project008-output.PNG" width="500" >
</div>
...
<h2>Output:</h2>
<div>
<img src="/assets/images/project009-output.PNG" width="500" >
</div>
...
<h2>Output:</h2>
<div>
<img src="/assets/images/project010-output.PNG" width="500" >
</div>
...
<h2>Output:</h2>
<div>
<img src="/assets/images/project011-output.PNG" width="500" >
</div>
<hr/>
...
<h2>Output:</h2>
<div>
<img src="/assets/images/project012-output.PNG" width="500" >
</div>
<hr/>
...
<p>26.Alien Colors #2: Choose a color for an alien as you did in Exercise 25, and write an if-else chain.
<br>
...
<p>27.Alien Colors #3: Turn your if-else chain from Exercise 5-4 into an if-else chain.
<br>
...
<p>28.Stages of Life: Write an if-else chain that determines a person’s stage of life. Set a value for the variable age, and then:
<br>
...
<p>29.Favorite Fruit: Make a array of your favorite fruits, and then write a series of independent if statements that check for certain fruits in your array.
<br>
...
<p>30.Hello Admin: Make a array of five or more usernames, including the name 'admin'. Imagine you are writing code that will print a greeting to each user after they log in to a website. Loop through the array, and print a greeting to each user:
<br>
...
<p>31.No Users: Add an if test to Exercise 28 to make sure the list of users is not empty.
<br>
...
<p>32.Checking Usernames: Do the following to create a program that simulates how websites ensure that everyone has a unique username.
<br>
...
<p>33.Ordinal Numbers: Ordinal numbers indicate their position in a array, such as 1st or 2nd. Most ordinal numbers end in th, except 1, 2, and 3.
<br>
...
<p>34.Pizzas: Think of at least three kinds of your favorite pizza. Store these pizza names in a array, and then use a for loop to print the name of each pizza.
<br>
...
<p>35.Animals: Think of at least three different animals that have a common characteristic. Store the names of these animals in a list, and then use a for loop to print out the name of each animal. 
<br>
...
<p>36.T-Shirt: Write a function called make_shirt() that accepts a size and the text of a message that should be printed on the shirt. The function should print a sentence summarizing the size of the shirt and the message printed on it. Call the function.
